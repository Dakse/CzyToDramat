...
function Home() {
  ...
  var getResponseFromApi = function getResponseFromApi(input) {
    setStatus("loading");
    var fuse = new fuse_js__WEBPACK_IMPORTED_MODULE_3__["default"](list, options);
