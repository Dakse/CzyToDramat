...
function Home() {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])("ready"),
      status = _useState[0],
  ...
  var getResponseFromApi = function getResponseFromApi(input) {
    if (status !== "loading") {
      setStatus("loading");
      axios__WEBPACK_IMPORTED_MODULE_10___default.a.get("https://wolnelektury.pl/api/books").then(function (response) {
        var data = new fuse_js__WEBPACK_IMPORTED_MODULE_4__["default"](response.data, options).search(input)[0];
  ...
  }, "Czy to dramat?"), status === "loading" && __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__["CircularProgress"], {
    size: 90,
    style: {
      marginTop: "0.5em",
      textAlign: "center"
  ...
  }, __jsx(_material_ui_icons_Error__WEBPACK_IMPORTED_MODULE_7___default.a, {
    style: {
      marginTop: "0.5em",
      textAlign: "center",
      fontSize: 100,
  ...
  }, "Nie znalazłem utworu o takiej nazwie w bazie")), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_5__["TextField"], {
    align: "center",
